/*Bài 3: Cho mảng gồm n số nguyên. Lập trình giải các bài toán sau 
a) Nhập n và mảng gồm n số nguyên. 
b) Tính tổng các số nguyên tố. 
c) Tìm số nguyên tố lớn nhất. 
d) Tìm số dương lớn nhất và số âm bé nhất trong dãy. Trong trường hợp không có số 
âm hay số dương nào trong dãy thì in ra *. 
e) Sắp xếp dãy giảm dần.*/
